...
type ManagerConfig struct {
	...
	Net                *vnet.Net
	AllocatePacketConn func(network string, dst net.IP, requestedPort int) (net.PacketConn, net.Addr, error)
	AllocateConn       func(network string, dst net.IP, requestedPort int) (net.Conn, net.Addr, error)
}
...
func (m *Manager) CreateAllocation(
	...
	conn, relayAddr, err := m.allocatePacketConn("udp4", dstIP, requestedPort)
	if err != nil {
		return nil, err
	}
